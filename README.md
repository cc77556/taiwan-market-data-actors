...
Clean JSON APIs for Taiwan stock market and government data — institutional flows, financial statements, dividends, margin/short balances, insider filings, procurement tenders, real estate prices and more. 33 Actors on the [Apify platform](https://apify.com/chamarix), all built the same way:
